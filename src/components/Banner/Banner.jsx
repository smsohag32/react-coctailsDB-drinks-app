    ...
    <div className="carousel w-full h-[450px]">
      ...
      <div id="slide4" className="carousel-item relative w-full">
        ...
        <p className="absolute top-[50%] px-60 bg-opacity-60 text-black">
          ...
          accusamus deleniti exercitationem totam quibusdam eos quisquam, quam
          odio ipsum laboriosam! Nobis deserunt temporibus earum animi magnam
          rerum, tenetur nemo odit.
        </p>
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a href="#slide3" className="btn btn-circle">
            ❮
